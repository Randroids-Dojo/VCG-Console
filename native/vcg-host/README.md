...
The host implements direct child-process supervision, bounded heartbeat recovery, an operating-system resource-fault boundary, and the canonical input boundary. It does not yet claim SDL3, compositor, origin-containment, RetroArch, Wi-Fi, storage, tracker, or target-Linux resource-detector qualification.
